...
import { findUnknownScopes, KNOWN_SCOPES, WILDCARD_SCOPE } from "~/lib/governance/scopes"
...
type AllowedExpiry = (typeof ALLOWED_EXPIRY_DAYS)[number]
...
// Re-export for the UI's hardcoded option list.
export { ALLOWED_EXPIRY_DAYS, KNOWN_SCOPES, WILDCARD_SCOPE }
